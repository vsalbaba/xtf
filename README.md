...
* `xtf.maven.script.enabled` - boolean switch whether Maven needs to be activated . Defaults to `true` if not set. Set to `false` if you want to disable Maven activation.
